...
const config: Config = {
  ...
  baseUrl: '/mg-16-code-skill-v2/',

  organizationName: 'jeekeagle',
  projectName: 'mg-16-code-skill-v2',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/jeekeagle/mg-16-code-skill-v2/edit/main/',
          routeBasePath: '/',
        },
        blog: false,
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {href: 'https://github.com/jeekeagle/mg-16-code-skill-v2', label: 'GitHub', position: 'right'},
      ],
    },
    footer: {
      style: 'dark',
      links: [
        ...
        },
        {
          title: '更多',
          items: [
            {label: 'GitHub 仓库', href: 'https://github.com/jeekeagle/mg-16-code-skill-v2'},
